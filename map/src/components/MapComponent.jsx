...
const MapComponent = () => {
  ...
  useEffect(() => {
    if (mapRef.current && userLocation && userLocation[0] && userLocation[1]) {
      mapRef.current.leafletElement.setView(userLocation, 13); // Update map center
    }
  }, [userLocation]);
